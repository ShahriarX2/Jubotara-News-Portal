            ...
            <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-secondary backdrop-blur-xl border-t border-gray-100 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] pb-safe">
                <div className="flex items-center justify-between h-16 px-2 max-w-lg mx-auto">
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                key={item.path}
                                href={item.path}
                                className={`flex flex-col items-center justify-center w-full h-full space-y-1 transition-all duration-300 ${isActive ? 'text-primary' : 'text-white hover:text-primary'
                                    }`}
                            >
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center justify-center w-full h-full space-y-1 transition-all duration-300 ${isMenuOpen ? 'text-primary' : 'text-white hover:text-primary'
                            }`}
                    >
