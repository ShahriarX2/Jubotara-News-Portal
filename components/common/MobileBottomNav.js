...
import { ChevronRight, Globe, Home, Menu, Newspaper, X } from "lucide-react";
import { FaFacebookF, FaTwitter, FaYoutube } from "react-icons/fa";

export default function MobileBottomNav({ news_categories, siteName = "Jubotara" }) {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-[100] md:hidden bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] pb-safe">
            ...
            return (
              ...
              >
                <div
                  className={
                    isActive
                      ? "scale-110 drop-shadow-[0_0_8px_rgba(238,29,35,0.4)]"
                      : ""
                  }
                >
                  {item.icon}
