...
//             {/* Mobile Menu Overlay */}
//             {isOpen && (
//                 <div className="fixed inset-0 top-[60px] bg-secondary z-[100] p-6 lg:hidden overflow-y-auto">
...
//                                     className={`text-2xl font-black flex items-center justify-between ${pathname === `/category/${item?.slug}`
//                                         ? 'text-white'
...
//                                                     href={`/category/${subItem.slug}`}
//                                                     onClick={() => setIsOpen(false)}
//                                                     className={`text-lg font-bold ${pathname === `/category/${subItem.slug}`
//                                                         ? 'text-white'
...
//                                 href="/video"
//                                 onClick={() => setIsOpen(false)}
//                                 className={`text-2xl font-black ${pathname === "/video"
//                                     ? 'text-white'
//                                     : 'text-white/70'
//                                     }`}
//                             >
